...
const buttonVariants = cva(
  "rounded-[4px] font-bold text-sm uppercase transition-colors inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-light focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-90 dark:ring-offset-neutral-950 dark:focus-visible:ring-neutral-300",
  {
    variants: {
      variant: {
