...
const DashboardStats: FC = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatsCard bgColor='bg-blue-100 text-primary' icon={<BookOpen size={24} />} title='Total bookings' value="156" />
            ...
            <StatsCard bgColor='bg-blue-100 text-primary' icon={<DollarSign size={24} />} title='Total bookings' value="1546" />
        </div>
    );
};
