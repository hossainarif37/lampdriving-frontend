...
import LearnerBookingActions from './LearnerBookingActions';

const LearnerBookingsTable: FC = () => {
        ...
        <div className='min-h-[calc(100vh-189px)] flex flex-col text-primary'>
            {
                data?.data.result.length ?
                    ...
                    <div className='flex-1 flex items-center justify-center'>
                        <DataNotFound isSearched={isSearched} dataName='Learner Bookings' />
                    </div>
            }
...
export default LearnerBookingsTable;